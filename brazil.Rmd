...
* First half of the lecture:
  ...
  - A brief overview of the Brazilian political system: Fragmented parties,
    open-list proportional representation, and strong presidential rule ([Figueiredo and Limongi,
  2000](https://www.jstor.org/stable/422395))
  ...
  - Brazil's new populist right: The rise (and fall?) of Jair Bolsonaro
    ([Hunter and Power, 2019](https://doi.org/10.1353/jod.2019.0005))

--

* Second half of the lecture:

  - Our new research on legislature size and welfare provision in Brazil
    ([Mignozzetti, Cepaluni and Freire, 2021](https://github.com/umbertomig/legislature-size-welfare))
...
.pull-left[
* **The _Operation Car Wash (Lava Jato)_** was a massive corruption investigation against political corruption in Brazil
...
* Population has also punished him for his handling of the pandemic: 20% of approval

* Two plausible scenarios: 1) more competent conservative president; 2) Lula for the third time
]

--

.large[
* However, _bolsonarismo_ will likely outlast Bolsonaro's term
]
...
#### Umberto Mignozzetti (Emory)
#### Gabriel Cepaluni (São Paulo State)
